...
var i = class {
    ...
    r = class {
        ...
        onWheel = (t) => {
            ...
            ;((e *=
                1 === s ? o
                : 2 === s ? this.window.width
                : 1),
                (i *=
                    1 === s ? o
                    : 2 === s ? this.window.height
                    : 1),
    ...
    Lenis = class {
        ...
        constructor({
            ...
            ;((window.lenisVersion = '1.3.17'),
                ...
                (this.virtualScroll = new r(s, { touchMultiplier: g, wheelMultiplier: S })),
        ...
        onClick = (t) => {
            const e = t
                .composedPath()
                .filter((t) => t instanceof HTMLAnchorElement && t.getAttribute('href'))
        ...
        onVirtualScroll = (t) => {
            ...
            if (
                (this.emitter.emit('virtual-scroll', { deltaX: e, deltaY: i, event: s }), s.ctrlKey)
            )
                return
